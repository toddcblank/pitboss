...
urlpatterns = patterns('',
    ...
    url(r'^game/(?P<gameId>\d+)/eliminate-player?$', gameViews.elminatePlayer, name="eliminatePlayer"),
    url(r'^game/(?P<gameId>\d+)/remove-player?$', gameViews.removePlayerFromGameInProgress, name="removePlayerFromGameInProgress"),
    url(r'^game/(?P<gameId>\d+)/undo-eliminate-player?$', gameViews.undoElminatePlayer, name="undoElminatePlayer"),
